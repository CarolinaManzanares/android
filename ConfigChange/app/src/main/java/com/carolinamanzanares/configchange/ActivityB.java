...
public class ActivityB extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOpenMain = (Button)findViewById(R.id.btnOpenMain);
        Button btnCloseB = (Button)findViewById(R.id.btnCloseB);

        btnOpenMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("CHANGE", "ActivityB onClick() btnOpenMain");

                Intent openMain;
                openMain = new Intent(ActivityB.this, MainActivity.class);
        ...
        btnCloseB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("CHANGE", "ActivityB onClick() btnCloseB");
                finish();
            }
        });
    }
